...
import { Button, Drawer, DrawerContent, DrawerDescription, DrawerHeader, DrawerTitle } from '@/shared/ui';
...
const EndWorkoutDrawer: FC<EndWorkoutDrawerProps> = ({ open, onOpenChange, workoutId }) => {
    ...
    const handleEndWorkoutSubmit = (data: { feedback: string }) => {
        completeWorkoutMutation.mutateAsync({
            sessionId: workoutId,
...
onOpenChange={onOpenChange}>
            <DrawerContent>
                ...
                <form onSubmit={handleSubmit(handleEndWorkoutSubmit)}
...
placeholder={t("feedback-placeholder")} />
                    ...
                    <Button type="submit"
className="mt-4 w-full">{t("end-workout")}</Button>
                </form>
            </DrawerContent>
        </Drawer>
    );
